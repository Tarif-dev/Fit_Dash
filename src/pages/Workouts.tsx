...
const featuredWorkouts = [
  {
    ...
    level: "Intermediate",
    trainer: "Alex Chen",
    image: "/assets/c020f10b-2634-422d-a727-391b34f99883.png",
    ...
    <div className="min-h-screen bg-fitness-dark">
      ...
      >
        ...
        >
          ...
          <p className="text-fitness-text-gray">
        ...
        <motion.div variants={item}>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
            {workoutCategories.map((category, index) => (
              ...
              >
                <div
                  className={`${category.color} bg-opacity-20 p-2 rounded-lg inline-flex mb-3`}
                >
                  <div
                    className={`${category.color} rounded-md p-1 text-white`}
                  >
                    {category.icon}
                  </div>
                </div>
            ...
            {featuredWorkouts.map((workout, index) => (
              ...
              >
                <div className="absolute inset-0 opacity-20">
                  ...
                  />
                  <div
                    className={`absolute inset-0 bg-gradient-to-t ${workout.color} opacity-80`}
                  ></div>
                </div>

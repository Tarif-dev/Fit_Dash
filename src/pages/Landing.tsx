...
const Landing = () => {
  ...
  const { scrollYProgress } = useScroll({
    target: targetRef,
    offset: ["start start", "end end"], // Adjusted offset to improve visibility
  });

  // Adjusted transform parameters to be less aggressive
  ...
  const features = [
    {
      ...
      description:
        "Monitor vital signs including heart rate, blood pressure, and oxygen levels.",
    },
    {
      icon: <Activity className="w-6 h-6 text-blue-500" />,
      title: "Activity Metrics",
      description:
        "Track steps, distance, active minutes, and calories burned daily.",
    },
    {
      icon: <Flame className="w-6 h-6 text-orange-500" />,
      title: "Calorie Management",
      description:
        "Balance your caloric intake and expenditure for optimal results.",
    },
    {
      icon: <Dumbbell className="w-6 h-6 text-purple-500" />,
      title: "Workout Library",
      description:
        "Access hundreds of exercises with detailed form guides and videos.",
    },
    {
    ...
    },
    {
      ...
      title: "Goal Setting",
      description:
        "Set personalized targets and track your progress toward achievement.",
    },
  ];

  return (
    <div className="min-h-screen bg-gradient-to-b from-fitness-dark to-black overflow-x-hidden">
      {/* Hero Section */}
      <motion.div
        className="min-h-screen py-24 relative flex flex-col justify-center items-center px-4 md:px-8"
      ...
      >
        ...
        >
          ...
          <motion.p
            ...
            variants={itemVariants}
          >
            Experience the future of fitness tracking with our AI-powered
            dashboard. Get real-time insights, personalized recommendations, and
            track every aspect of your health.
          </motion.p>
      ...
      <section className="py-24 px-4 md:px-8 max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">
            ...
            <span className="text-fitness-orange">Elite Performance</span>
          </h2>
          <p className="text-white/70 max-w-2xl mx-auto">
            Our fitness dashboard combines cutting-edge technology with
            intuitive design to deliver the most comprehensive fitness tracking
      ...
      >
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center px-4">
          ...
          >
            ...
            <span className="text-fitness-orange">Fitness Experience?</span>
          </motion.h2>
          ...
          >
            ...
            goals with our intelligent tracking and personalized insights.
          </motion.p>
